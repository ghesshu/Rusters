...
const About = (props) => {
    ...
    return (
      <section
        ...
        className={`ico_about_section section_space pb-0 section_decoration ${props.abClass}`}
      >
        <div className="container">
          <div className="row justify-content-lg-between">
            <div className="col-lg-6">
              ...
              >
                <h2 className="heading_text mb-0">💡 Why Choose Rasters?</h2>
              </div>
              <ul className="about_ico_block unordered_list_block">
                ...
                >
                  ...
                  <p className="info_description mb-0">
                    ...
                    pump-and-dump memecoins, Rasters gives you a serious edge
                    with intelligent, automated decision-making—designed for the
                    speed of Web3.
                  </p>
                </li>
                <li
                  ...
                  data-aos-delay="200"
                >
                  <h3 className="title_text">AI Agents, Not Just Bots</h3>
                  <p className="info_description mb-0">
                    Most trading bots follow scripts. Rasters uses specialized
                    AI agents that analyze risk, strategy, sentiment, and
                    liquidity—then act together in perfect sync.
                  </p>
                </li>
                <li
                  data-aos="fade-up"
                  ...
                  data-aos-delay="300"
                >
                  <h3 className="title_text">Real-Time Market Awareness</h3>
                  <p className="info_description mb-0">
                ...
                >
                  <h3 className="title_text">
                    Social Intelligence via Sentiment Analysis
                  </h3>
                  <p className="info_description mb-0">
                    Using NLP and machine learning, Rasters tracks social buzz
                    across platforms like Twitter, Telegram, Discord, and Reddit
                ...
                >
                  <h3 className="title_text">
                    Execution with Liquidity Awareness
                  </h3>
                  <p className="info_description mb-0">
                    The Liquidity Agent ensures optimal routing, low slippage,
                    and MEV protection—executing trades at the best price
                    available across DEXs.
                  </p>
                </li>
              </ul>
            </div>
            <div className="col-lg-5 d-lg-flex flex-lg-column-reverse">
              <ul className="about_ico_block unordered_list_block">
                <li
                  ...
                  data-aos-delay="100"
                >
                  <h3 className="title_text"> Built for the Memecoin World</h3>
                  <p className="info_description mb-0">
                    From stealth launches to trending tokens, memecoin markets
                    move fast. Rasters is built to trade them with intelligence,
                    precision, and speed.
                  </p>
                </li>
              </ul>
