    ...
    >
      <div className="container">
        <h1 className="hero_title" data-aos="fade-up" data-aos-duration="800">
          Rasters – AI-Native Autonomous Trading for Memecoins
        </h1>
        {/* <h1 className="fs-4" data-aos="fade-up" data-aos-duration="800">
          Real-time, agent-powered trading intelligence that combines Risk •
          Strategy • Sentiment • Liquidity into one adaptive, autonomous
          platform.
        </h1> */}
        ...
        >
          <li>
            <Link className="ico_creative_btn" href="#">
              <span className="btn_wrapper">
                ...
                <span className="btn_label">
                  Real-time, agent-powered trading intelligence that combines
                  Risk • Strategy • Sentiment • Liquidity into one adaptive,
                  autonomous platform.
                </span>
        ...
        <div data-aos="fade-up" data-aos-duration="900" data-aos-delay="200">
          <div className="ico_countdown_progress_box">
            <div className="ico_heading_block text-center mb-0">
              <h2 className="highlight_title mb-0">Start buy Rasters now!</h2>
            </div>
            <div
              className="countdownbg"
              style={{
                backgroundImage: `url(${"/images/shapes/shape_bg_ico_countdown.svg"})`,
              }}
            >
              <TimeCountDown />
            </div>
