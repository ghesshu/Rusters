...
const TokenOffer = () => {
  ...
  return (
    <section
      id="id_token_offer"
      className="memecoin_countdown_section section_space section_decoration"
    >
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div
              className="memecoin_heading_block"
              data-aos="fade-up"
            ...
            >
              ...
              <ul className="coins_group unordered_list">
                {[
                  { src: coinBTC, label: "BTC" },
                  { src: coinETH, label: "ETH" },
                  { src: coinEOS, label: "EOS" },
                  { src: coinUSD, label: "USD" },
                  { src: coinLTC, label: "LTC" },
                ].map((coin, index) => (
                  <li key={index}>
          ...
          <div className="col-lg-6">
            <div className="memecoin_countdown_wraper text-center">
              ...
              <div className="countdown_wrapper">
                ...
                <TimeCountDown />
                <ul
                  className="countdown_timer_block unordered_list justify-content-center"
