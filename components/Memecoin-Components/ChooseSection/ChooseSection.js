...
const ChooseSection = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${"/images/shapes/memecoin_bg_shape_2.svg"})`,
      }}
    >
      <div className="container">
            ...
            >
              <div className="memecoin_iconbox_block">
                ...
                <div className="iconbox_info">
                  <h3 className="iconbox_title text-uppercase">
                    {service.title}
                  </h3>
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${"/images/shapes/shape_net_2.svg"})`,
          }}
          data-aos="fade-up"
          data-aos-duration="800"
          data-aos-delay="400"
        >
          <div className="memecoin_heading_block">
            <h3 className="heading_text text-uppercase mb-0 text-light">
              Get Coin Now ON
            </h3>
          </div>
          ...
          <div className="token_copy_board">
            ...
            <span className="code">
              ...
              <mark>Oxe3c127466908c2ccdc43521c8315b87fd369d605</mark>
            </span>
            <button
              className="copy_btn"
              type="button"
