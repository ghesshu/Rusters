...
const AboutSection = () => {
  ...
  return (
    <section
      id="id_about_memecoin_section"
      className="about_memecoin_section section_space section_decoration"
    >
      <div className="container">
        <div className="row">
          <div className="col-lg-6 mb-5 mb-lg-0">
            <div
              className="memecoin_heading_block mb-0"
              data-aos="fade-up"
            ...
            >
              ...
              <p className="heading_description mb-0 pe-lg-5">
                The Meme Coin blends fun, community, and value in crypto! More
                than just a token, it’s a movement driven by creativity and
                innovation. Join the revolution and reshape meme culture!
              </p>
            </div>
            <div
