...
const Header3 = (props) => {
  ...
  return (
    <header
      className={`site_header header_pepecoin  ${isSticky ? "sticky" : ""}`}
    >
            ...
            <div className="col-lg-9 col-7 d-flex align-items-center justify-content-end">
                ...
                >
                  <ul className="main_menu_list unordered_list text-uppercase main-menu">
                    ...
                    <li>
                      ...
                      >
                        <span className="nav_link_label" data-text="About">
                          About
                        </span>
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="id_pepecoin_feature_section"
                        spy={true}
                        smooth={true}
                        duration={500}
                        offset={-100}
                        className="nav-link scrollspy_btn"
                      >
                        <span className="nav_link_label" data-text="How to buy">
                          How to buy
                        </span>
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="id_pepecoin_tokenomics_section"
                        spy={true}
                        smooth={true}
                        duration={500}
                        offset={-100}
                        className="nav-link scrollspy_btn"
                      >
                        <span className="nav_link_label" data-text="Tokenomics">
                          Tokenomics
                        </span>
                      </Link>
                    </li>
                    <li className="dropdown">
                      ...
                      >
                        <li>
                          <Link
                            to="id_pepecoin_roadmap_section"
                            spy={true}
                            smooth={true}
                            duration={500}
                            offset={-100}
              ...
              <ul className="btns_group unordered_list p-0 justify-content-end">
                <li className="d-lg-none">
                  <button
                    className="mobile_menu_btn text-white"
                    type="button"
